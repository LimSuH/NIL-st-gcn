...
OUTPUT_PATH = '/hdd1/dataset/KETI_SignLanguage/Keypoints/'
...
def norm_numpy_totensor(img):
    ...
    return torch.from_numpy(img).permute(0, 3, 1, 2) # [batch, channel, height, width]?
    ...
    with torch.no_grad():
        ...
        for i, path in enumerate(paths):
            ...
            while cap.isOpened():
                ...
                out = []
                for scale in multi_scales: # why use multi scales? [512, 640]
                    if scale != 512:
                ...
                out = merge_hm(out) # averaging flipped and original images after estimation?
